    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            {(part.type === 'Cooler' ||
                part.type === 'Case') &&
            <div className="field">
                <label htmlFor="coolerHeight">Cooler height/Clearance</label>
                <input
                    id="coolerHeight"
                    name="coolerHeight"
                    className="input"
                    placeholder="mm"
                    onChange={handleChange}
                    value={part.coolerHeight || ''}
                />
                {errors.coolerHeight && <div className="error">{errors.coolerHeight}</div>}
            </div>}

            {part.type === 'Cooler' &&
            <div>
                <div className="field">
                    <label htmlFor="compatibleSockets">Compatible Socket(s)</label>
                    <div className="control">
                        <div className="select">
                            <select
                                id="compatibleSockets"
                                name="compatibleSockets"
                                onChange={handleChange}
                                value={part.compatibleSockets || ''}>
                                <option>Please select</option>
                                <option value="4">AMD X399</option>
                                <option value="3">AMD AM4</option>
                                <option value="2">AMD FM2 - AM3+</option>
                                <option value="1">LGA 2011/LGA 2066 (Intel HEDT)</option>
                                <option value="0">LGA 1155/1150/1151 (Sandy Bridge - Coffee Lake)</option>

                            </select>
                        </div>
                    </div>
                    {errors.compatibleSockets && <div className="error">{errors.compatibleSockets}</div>}
                </div>

                <div className="field">
                    <label htmlFor="coolerFanSize">Fan Size</label>
                    <div className="control">
                        <div className="select">
                            <select
                            id="coolerFanSize"
                    ...
                    {errors.coolerFanSize && <div className="error">{errors.coolerFanSize}</div>}
                </div>
            </div>}
